INC = -Ilib/sokol -Ilib/sokol/util -Ilib/logc/src -Isrc/ -Isrc/components -Ilib/cglm/include -Ilib/stc/include -Ilib/fastobj

src = $(wildcard src/**/*.c) $(wildcard src/*.c)
outputs = $(wildcard build/**/*.o) $(wildcard build/*.o)
